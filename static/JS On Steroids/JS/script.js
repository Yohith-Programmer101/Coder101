...
function rpsGame(yourChoice) {
    ...
    results = decideWinner(humanChoice, botChoice); // [0, 1]  human lost | the bot won
    console.log(results);
...
function rpsFrontEnd(humanImageChoice, botImageChoice, finalMessage) {
    ...
    botdiv.innerHTML = "<img src='" + imagesDatabase[botImageChoice] + "' width='150' height='150' style='box-shadow: 0px 10px 50px rgba(243, 50, 24, 1);'>";
